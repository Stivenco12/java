...
public class Menu {
    public static int menu() {
        ...
        System.out.println("Ejercicio 10 = Calculo de intereses Compuestos sobre una inversion");
        System.out.println("Ejercicio 11 = Simulacion de Depositos en una cuenta Bancaria con intereses");
        System.out.println("Ejercicio 12 = Salir ");
        System.out.print("Ingresa el numero del ejercicio al que quieres ir = ");
        return menu;
    }
}
